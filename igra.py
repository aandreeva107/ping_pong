...
display.set_caption('Кe')
background = transform.scale(image.load('777.jpg'), (700,500))
sprite1 = GameSprite('mor.png',600,300,5)
sprite2 = GameSprite('mor.png',0,300,5)
ball = GameSprite('krol.png',200,200,5)
fps=60
game = True
finish = False
speed_x = 3
